...
class FireSword(pygame.sprite.Sprite):
    '''
    classdocs
    '''
    ...
    def __init__(self,xpos,ypos, killFunction):
        ...
        self.base_image, self.rect = load_image_from_folder('fire_sword', 'flaming_sword.png',-1)
        self.image = self.base_image
        self.killFunction = killFunction
        self.xpos = xpos
        self.ypos = ypos
        
        self.attack_type = self.TYPE_FIRE_SWORD
